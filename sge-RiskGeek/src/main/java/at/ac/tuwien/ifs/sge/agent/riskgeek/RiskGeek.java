package at.ac.tuwien.ifs.sge.agent.riskgeek;
...
public class RiskGeek<G extends Game<A, ?>, A> extends AbstractGameAgent<G, A> implements
    GameAgent<G, A> {
  ...
  public RiskGeek(Logger log) {
    this(Math.sqrt(2), log);
  }

  public RiskGeek(double exploitationConstant, Logger log) {
    super(log);
